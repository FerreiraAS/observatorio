...
```{r AC, eval = has.dados.cadastrais}
area.raw <-
...
```{r LP, eval = has.dados.cadastrais}
linhas.raw <-
  readxl::read_excel("PPG/Dados Cadastrais.xlsx",
             sheet = "LP",
             col_types = c("text"))
...
```{r PP-lista, eval = has.sucupira.files}
table.projetos <-
  data.frame(
...
```{r projetos-de-pesquisa-em-andamento-tabela, eval = has.sucupira.files}
