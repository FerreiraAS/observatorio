...
```{r quadrienal-vigente, results = "hide"}
# periodo
quadrienal.vigente <- 2021:min(as.numeric(format(Sys.Date(), "%Y")), 2024)
```

```{r cover-one, fig.align = 'right', echo = FALSE, include = identical(knitr:::pandoc_to(), 'html'), fig.link = 'PPG/Images/Cover_1.png', out.width = "100%", eval = !knitr::is_html_output()}
source("Scripts/cover_1.R", local = knitr::knit_global())
knitr::include_graphics('PPG/Images/Cover_1.png', dpi = NA)
```
...
if (dim(disciplinas.raw)[1] != 0) {
  ...
  turmas.docentes[turmas.docentes == 0] <- ""
  print(
    kkableExtra::able(turmas.docentes, align = c("l", rep(
