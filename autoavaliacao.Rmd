...
<iframe src="https://drive.google.com/file/d/1nH6uwlrnGT-FaR7CoJ3LfaEH_7yVhvE9/preview" style=\"width:100%; height:600px; border:2px solid black;"></iframe> height:600px; border:2px solid black;"></iframe>
...
<iframe src="https://drive.google.com/file/d/1nVBJsNtabVPDJjBJqISPsrnpUs3THSx-/preview" style=\"width:100%; height:600px; border:2px solid black;"></iframe> height:600px; border:2px solid black;"></iframe>
...
<iframe src="https://drive.google.com/file/d/1fi5VtKblMVEZ--_0_49ijnFn0VmqDyfS/preview" style=\"width:100%; height:600px; border:2px solid black;"></iframe> height:600px; border:2px solid black;"></iframe>
...
<iframe src="https://drive.google.com/file/d/1nRjCxEUpVdmoD5rY5Xa8EwnPbSoHmqE_/preview" style=\"width:100%; height:600px; border:2px solid black;"></iframe> height:600px; border:2px solid black;"></iframe>
...
<iframe src="https://drive.google.com/file/d/1nSLC_mwELkrjKq2sMktkFgHooKwjgKRi/preview" style=\"width:100%; height:600px; border:2px solid black;"></iframe> height:600px; border:2px solid black;"></iframe>
...
<iframe src="https://drive.google.com/file/d/1pX9XpxS4U3k5sjkXA9mZ54nyK2-XT2FS/preview" style=\"width:100%; height:600px; border:2px solid black;"></iframe> height:600px; border:2px solid black;"></iframe>
...
<iframe src="https://drive.google.com/file/d/1nVoIuS-WV9g_C34MXL9ESZr2r330s9z2/preview" style=\"width:100%; height:600px; border:2px solid black;"></iframe> height:600px; border:2px solid black;"></iframe>
...
<iframe src="https://drive.google.com/file/d/1pd3TJKh-1xGKWMwcRB45-9P9rfaBA9jA/preview" style=\"width:100%; height:600px; border:2px solid black;"></iframe> height:600px; border:2px solid black;"></iframe>
...
if (has.ppg.files) {
  ...
  if (length(files.to.read) != 0) {
    for (i in 1:length(files.to.read)) {
      sheets <- excel_sheets(files.to.read[i])
      for (j in 1:length(sheets)) {
        sheet <- sheets[j]
        try(ppg.file <-
              readxl::read_excel(files.to.read[i], sheet = sheets[j]),
            silent = TRUE)
...
cat(
  paste(
    '<iframe src="',
    notas[1],
    '" style=\"width:100%; height:600px; border:2px solid black;"></iframe> height:600px; border:2px solid black;"></iframe>',
    sep = ""
  )
)
...
<iframe src="https://drive.google.com/file/d/1ilDduzPYnLHOlnhH-TUPL4cVPcq43Kqw/preview" style=\"width:100%; height:600px; border:2px solid black;"></iframe> height:600px; border:2px solid black;"></iframe>
...
<iframe src="https://drive.google.com/file/d/1ix-9zIVULXlJMvntkXWl38iDEdvziDyK/preview" style=\"width:100%; height:600px; border:2px solid black;"></iframe> height:600px; border:2px solid black;"></iframe>
...
<iframe src="https://drive.google.com/file/d/1k3PppnhBXToQItVOiMzSGAeGvwOYOXFN/preview" style=\"width:100%; height:600px; border:2px solid black;"></iframe> height:600px; border:2px solid black;"></iframe>
