...
```{r cursos-egressos, eval = has.dados.cadastrais}
# read separate sheets
...
```{r 1-1-1-posdocs, eval = has.sucupira.files}
# remove duplicates
table.all <- sucupira.df[!duplicated(sucupira.df[, -1]), ]
...
table.ac.gt <-
  ...
  modify_header(n = "**Sem classificação**")
```
...
```{r 1-1-1-posdoc, eval = has.sucupira.files}
table.posdoc <-
  data.frame(matrix(
    NA,
...
```{r 1-1-1-list-tables, eval = has.sucupira.files}
# list all tables
table.all <-
  list(table.ac.gt,
       table.lp.gt,
...
```{r posdoc-detalhes, eval = has.sucupira.files}
options(knitr.kable.NA = '')
print(
...
```{r producao-ac-detalhes, eval = has.sucupira.files}
options(knitr.kable.NA = '')
print(
  kable(table.ac, align = c("l", rep(
    "c", ncol(table.ac) - 2
...
```{r producao-lp-detalhes, eval = has.sucupira.files}
options(knitr.kable.NA = '')
print(
  kable(table.lp, align = c("l", rep(
    "c", ncol(table.lp) - 2
...
```{r producao-detalhes, eval = has.sucupira.files}
options(knitr.kable.NA = '')
print(
...
```{r autor-detalhes, eval = has.sucupira.files}
options(knitr.kable.NA = '')
print(
...
```{r tecnica-detalhes, eval = has.sucupira.files}
options(knitr.kable.NA = '')
print(
...
```{r bibliografica-detalhes, eval = has.sucupira.files}
options(knitr.kable.NA = '')
print(
...
```{r tecnioca-detalhes, eval = has.sucupira.files}
options(knitr.kable.NA = '')
print(
