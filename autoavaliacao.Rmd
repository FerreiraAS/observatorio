...
cat('<div class="d-grid gap-2">
  <button class="btn btn-lg btn-primary" type="button">Quadrienal 2025-2028</button>
  <button class="btn btn-lg btn-primary" type="button">Quadrienal 2021-2024</button>
  <button class="btn btn-lg btn-primary" type="button">Quadrienal 2017-2020</button>
  <button class="btn btn-lg btn-primary" type="button">Quadrienal 2013-2016</button>
</div>')
```
