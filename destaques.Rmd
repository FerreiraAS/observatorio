...
```{r associacoes, cache = TRUE, eval = all(has.sucupira.files, curl::has_internet())}
# Docentes
sheet <- "Docentes"
...
```{r corpo-editorial, cache = TRUE, eval = all(has.sucupira.files, curl::has_internet())}
# Docentes
sheet <- "Docentes"
source("Scripts/read-xlsx-sucupira.R", local = knitr::knit_global())
...
```{r revisores, cache = TRUE, eval = all(has.sucupira.files, curl::has_internet())}
# Docentes
sheet <- "Docentes"
source("Scripts/read-xlsx-sucupira.R", local = knitr::knit_global())
