...
```{r pandemia-filtro-eventos, eval = has.eventos.ppg}
# dplyr::selecting those with COVID in the title
try(doi_with_altmetric_eventos_impacto <-
      doi_with_altmetric_eventos[grep(paste(tolower(pandemia), collapse = "|"),
                              tolower(doi_with_altmetric_eventos$title)), ], silent = TRUE)
try(doi_without_altmetric_eventos_impacto <-
      doi_without_altmetric_eventos[grep(paste(tolower(pandemia), collapse = "|"),
                                 tolower(doi_without_altmetric_eventos$title)), ],
    silent = TRUE)
...
```{r pandemia-resumos-eventos, eval = has.eventos.ppg}
# bind sources
try(doi_with_altmetric <- doi_with_altmetric_eventos_impacto, silent = TRUE)
try(doi_without_altmetric <- doi_without_altmetric_eventos_impacto, silent = TRUE)
