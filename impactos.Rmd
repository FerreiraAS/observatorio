...
try(my_dois_works_artigos_impacto <-
      my_dois_works_artigos[grep(paste(tolower(pandemia), collapse = "|"),
                                 tolower(my_dois_works_artigos$title)), ],
    silent = TRUE)
...
try(my_dois_works_resumos_impacto <-
      my_dois_works_resumos[grep(paste(tolower(pandemia), collapse = "|"),
                                 tolower(my_dois_works_resumos$title)),],
    silent = TRUE)
...
try(doi_unique_preprints_impacto <-
    ...
    silent = TRUE)
try(my_dois_works_preprints_impacto <-
      my_dois_works_preprints[grep(paste(tolower(pandemia), collapse = "|"),
                                   tolower(my_dois_works_preprints$title)),],
    silent = TRUE)
...
try(my_dois_works_livros_impacto <-
      my_dois_works_livros[grep(paste(tolower(pandemia), collapse = "|"),
                                tolower(my_dois_works_livros$title)), ],
    silent = TRUE)
...
try(doi_unique_capitulos_impacto <-
    ...
    silent = TRUE)
try(my_dois_works_capitulos_impacto <-
      my_dois_works_capitulos[grep(paste(tolower(pandemia), collapse = "|"),
                                   tolower(my_dois_works_capitulos$title)), ],
    silent = TRUE)
...
try(my_dois_works_eventos_impacto <-
      my_dois_works_eventos[grep(paste(tolower(pandemia), collapse = "|"),
                                 tolower(my_dois_works_eventos$title)), ],
    silent = TRUE)
...
try(my_dois_works <- my_dois_works_artigos_impacto, silent = TRUE)
...
try(my_dois_works <- my_dois_works_resumos_impacto, silent = TRUE)
...
try(my_dois_works <- my_dois_works_preprints_impacto, silent = TRUE)
...
try(my_dois_works <- my_dois_works_livros_impacto, silent = TRUE)
...
try(my_dois_works <- my_dois_works_capitulos_impacto, silent = TRUE)
...
try(my_dois_works <- my_dois_works_eventos_impacto, silent = TRUE)
