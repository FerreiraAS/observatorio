...
item.detalhamento <- "Número do DOI"
...
if (dim(doi_artigos_resumos_sucupira)[1] != 0) {
  ...
  doi_artigos_anais_sucupira <- data.frame(doi_artigos_anais_sucupira[!is.na(doi_artigos_anais_sucupira)])
  names(doi_artigos_anais_sucupira) <- "DOI"
}
has.anais.sucupira <-
  length(doi_artigos_anais_sucupira) != 0
