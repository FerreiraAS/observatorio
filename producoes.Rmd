...
my_doi_works <- my_doi_works_artigos
...
my_doi_works <- my_doi_works_resumos
...
my_doi_works <- my_doi_works_preprints
...
my_doi_works <- my_doi_works_livros
...
my_doi_works <- my_doi_works_capitulos
...
my_doi_works <- my_doi_works_eventos
...
```{r retratacoes, eval = has.producao}
# get years
source("Scripts/years-sucupira.R", local = knitr::knit_global())
# bind sources
doi_unique <- dois_unique_retracted
my_doi_works <- my_doi_works_retracted
