...
cat('\n\n')
cat(
  '*OBS:* Dados de financiamento extraídos a partir dos trabalhos de conclusão de curso.'
)
cat('\n\n')
cat(
...
bolsistas <- select(bolsistas, c("Nome do Autor", "Nome do Orientador", "Matrícula", "Titulação"))
