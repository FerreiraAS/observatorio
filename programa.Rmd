...
```{r projetos-de-pesquisa-2024-grafico, eval = and(has.sucupira, has.avaliacao)}
...
```{r projetos-de-pesquisa-2024-tabela, eval = and(has.sucupira, has.avaliacao)}
periodo <- as.character(seq(min(periodos):max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <- projetos.all[projetos.all$`Membro Responsável`=="Sim" & projetos.all$Situação == "EM ANDAMENTO", ]
projetos <- unique(projetos)
...
```{r projetos-de-pesquisa-2024-lista, eval = and(has.sucupira, has.avaliacao)}
periodo <- as.character(seq(min(periodos):max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <-
...
```{r projetos-de-pesquisa-2020-grafico, eval = and(has.sucupira, has.avaliacao)}
periodo <- as.character(seq(min(periodos):max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <- projetos.all[projetos.all$`Membro Responsável`=="Sim" & projetos.all$Situação == "EM ANDAMENTO", ]
projetos <- unique(projetos)
...
```{r projetos-de-pesquisa-2020-tabela, eval = and(has.sucupira, has.avaliacao)}
periodo <- as.character(seq(min(periodos):max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <- projetos.all[projetos.all$`Membro Responsável`=="Sim" & projetos.all$Situação == "EM ANDAMENTO", ]
projetos <- unique(projetos)
...
```{r projetos-de-pesquisa-2020-lista, eval = and(has.sucupira, has.avaliacao)}
periodo <- as.character(seq(min(periodos):max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <-
  projetos.all[projetos.all$`Membro Responsável` == "Sim" &
...
```{r projetos-de-pesquisa-2016-grafico, eval = and(has.sucupira, has.avaliacao)}
periodo <- as.character(seq(min(periodos):max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <- projetos.all[projetos.all$`Membro Responsável`=="Sim" & projetos.all$Situação == "EM ANDAMENTO", ]
projetos <- unique(projetos)
...
```{r projetos-de-pesquisa-2016-tabela, eval = and(has.sucupira, has.avaliacao)}
periodo <- as.character(seq(min(periodos):max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <- projetos.all[projetos.all$`Membro Responsável`=="Sim" & projetos.all$Situação == "EM ANDAMENTO", ]
projetos <- unique(projetos)
...
```{r projetos-de-pesquisa-2016-lista, eval = and(has.sucupira, has.avaliacao)}
periodo <- as.character(seq(min(periodos):max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <-
  projetos.all[projetos.all$`Membro Responsável` == "Sim" &
...
```{r projetos-de-pesquisa-2012-grafico, eval = and(has.sucupira, has.avaliacao)}
periodo <- as.character(seq(min(periodos):max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <- projetos.all[projetos.all$`Membro Responsável`=="Sim" & projetos.all$Situação == "EM ANDAMENTO", ]
projetos <- unique(projetos)
...
```{r projetos-de-pesquisa-2012-tabela, eval = and(has.sucupira, has.avaliacao)}
periodo <- as.character(seq(min(periodos):max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <- projetos.all[projetos.all$`Membro Responsável`=="Sim" & projetos.all$Situação == "EM ANDAMENTO", ]
projetos <- unique(projetos)
...
```{r projetos-de-pesquisa-2012-lista, eval = and(has.sucupira, has.avaliacao)}
periodo <- as.character(seq(min(periodos):max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <-
  projetos.all[projetos.all$`Membro Responsável` == "Sim" &
...
```{r turmas-2024, eval = and(has.sucupira, has.avaliacao)}
# load custom function
source("Scripts/get-initials.R", local = knitr::knit_global())
...
```{r turmas-2020, eval = and(has.sucupira, has.avaliacao)}
# load custom function
source("Scripts/get-initials.R", local = knitr::knit_global())
...
```{r turmas-2016, eval = and(has.sucupira, has.avaliacao)}
# load custom function
source("Scripts/get-initials.R", local = knitr::knit_global())
...
```{r turmas-2012, eval = and(has.sucupira, has.avaliacao)}
# load custom function
source("Scripts/get-initials.R", local = knitr::knit_global())
