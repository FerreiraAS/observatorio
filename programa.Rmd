...
## **Área de avaliação** {.tabset #area-avaliacao}
...
if (dim(area.capes)[1] != 0) {
  ...
  create_dt(area.capes, title = "Áreas CAPES")
} else {
...
for (i in 1:length(abas)) {
  ...
  for (i in 1:dim(bolsas.raw)[1]) {
    bolsas.raw[i, 3] <-
      paste0('<a href="', bolsas.raw[i,3],'" target="_blank"', '>', "↗️" ,"</a>")
  }
  ...
  if (dim(bolsas.raw)[1] != 0) {
    source("Scripts/table-with-buttons.R", local = knitr::knit_global())
    create_dt(bolsas.raw, title = "Bolsas de estudo")
  } else {
    cat("*Sem dados para exibir*")
  }
...
for (i in 1:length(abas)) {
  ...
  for (i in 1:dim(convenios.raw)[1]) {
    convenios.raw[i, 3] <-
      paste0('<a href="', convenios.raw[i,3],'" target="_blank"', '>', "↗️" ,"</a>")
  }
  convenios.raw <- cbind(convenios.raw[,-3], Abrir)
  
  # print table
  if (dim(convenios.raw)[1] != 0) {
    source("Scripts/table-with-buttons.R", local = knitr::knit_global())
    create_dt(convenios.raw, title = "Convênios institucionais")
  } else {
    cat("*Sem dados para exibir*")
  }
...
for (j in 1:length(tabs)) {
  ...
  for (i in 1:dim(cooperacao)[1]) {
    ...
    cooperacao[i, 3] <-
      paste0('<a href="', cooperacao[i,3],'" target="_blank"', '>', "↗️" ,"</a>")
  }
  cooperacao <- cbind(cooperacao[,-3], Abrir)
...
for (j in 1:length(tabs)) {
  ...
  # print table
  if (dim(cooperacao)[1] != 0) {
    source("Scripts/table-with-buttons.R", local = knitr::knit_global())
    create_dt(cooperacao, title = "Cooperação Interinstitucional")
  } else {
    cat("*Sem dados para exibir*")
  }
...
for (j in 1:length(tabs)) {
  ...
  cat('\n\n<!-- -->\n\n')
  # print table
  if (dim(news.list[[j]])[1] != 0) {
    source("Scripts/table-with-buttons.R", local = knitr::knit_global())
    create_dt(news.list[[j]], title = "Cooperação Interinstitucional")
  } else {
    cat("*Sem dados para exibir*")
  }
  cat('\n\n<!-- -->\n\n')
