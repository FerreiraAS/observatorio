...
```{r projetos-de-pesquisa-2024-grafico, eval = has.avaliacao}
...
```{r projetos-de-pesquisa-2024-tabela, eval = has.avaliacao}
periodo <- as.character(seq(min(periodos), max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <- projetos.all[projetos.all$`Membro Responsável`=="Sim" & projetos.all$Situação == "EM ANDAMENTO", ]
projetos <- unique(projetos)
...
```{r projetos-de-pesquisa-2024-lista, eval = has.avaliacao}
periodo <- as.character(seq(min(periodos), max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <-
...
```{r projetos-de-pesquisa-2020-grafico, eval = has.avaliacao}
periodo <- as.character(seq(min(periodos), max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <- projetos.all[projetos.all$`Membro Responsável`=="Sim" & projetos.all$Situação == "EM ANDAMENTO", ]
projetos <- unique(projetos)
...
```{r projetos-de-pesquisa-2020-tabela, eval = has.avaliacao}
periodo <- as.character(seq(min(periodos), max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <- projetos.all[projetos.all$`Membro Responsável`=="Sim" & projetos.all$Situação == "EM ANDAMENTO", ]
projetos <- unique(projetos)
...
```{r projetos-de-pesquisa-2020-lista, eval = has.avaliacao}
periodo <- as.character(seq(min(periodos), max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <-
  projetos.all[projetos.all$`Membro Responsável` == "Sim" &
...
```{r projetos-de-pesquisa-2016-grafico, eval = has.avaliacao}
periodo <- as.character(seq(min(periodos), max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <- projetos.all[projetos.all$`Membro Responsável`=="Sim" & projetos.all$Situação == "EM ANDAMENTO", ]
projetos <- unique(projetos)
...
```{r projetos-de-pesquisa-2016-tabela, eval = has.avaliacao}
periodo <- as.character(seq(min(periodos), max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <- projetos.all[projetos.all$`Membro Responsável`=="Sim" & projetos.all$Situação == "EM ANDAMENTO", ]
projetos <- unique(projetos)
...
```{r projetos-de-pesquisa-2016-lista, eval = has.avaliacao}
periodo <- as.character(seq(min(periodos), max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <-
  projetos.all[projetos.all$`Membro Responsável` == "Sim" &
...
```{r projetos-de-pesquisa-2012-grafico, eval = has.avaliacao}
periodo <- as.character(seq(min(periodos), max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <- projetos.all[projetos.all$`Membro Responsável`=="Sim" & projetos.all$Situação == "EM ANDAMENTO", ]
projetos <- unique(projetos)
...
```{r projetos-de-pesquisa-2012-tabela, eval = has.avaliacao}
periodo <- as.character(seq(min(periodos), max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <- projetos.all[projetos.all$`Membro Responsável`=="Sim" & projetos.all$Situação == "EM ANDAMENTO", ]
projetos <- unique(projetos)
...
```{r projetos-de-pesquisa-2012-lista, eval = has.avaliacao}
periodo <- as.character(seq(min(periodos), max(periodos)))
projetos.all <- do.call(rbind.data.frame, sucupira.list[periodos])
projetos <-
  projetos.all[projetos.all$`Membro Responsável` == "Sim" &
...
```{r turmas-2024, eval = has.avaliacao}
# load custom function
source("Scripts/get-initials.R", local = knitr::knit_global())
...
```{r turmas-2020, eval = has.avaliacao}
# load custom function
source("Scripts/get-initials.R", local = knitr::knit_global())
...
```{r turmas-2016, eval = has.avaliacao}
# load custom function
source("Scripts/get-initials.R", local = knitr::knit_global())
...
```{r turmas-2012, eval = has.avaliacao}
# load custom function
source("Scripts/get-initials.R", local = knitr::knit_global())
...
# read separate sheets
turmas.raw <- read_excel("PPG/Calendários.xlsx", sheet = "Cooperação Interinstitucional", col_types = c("text"))
...
# read separate sheets
editais.raw <- read_excel("PPG/Editais.xlsx", sheet = "Sede", col_types = c("text"))
...
# read separate sheets
editais.raw <- read_excel("PPG/Editais.xlsx", sheet = "Cooperação Interinstitucional", col_types = c("text"))
...
# read separate sheets
infraestrutura <- read_excel("PPG/Infraestrutura.xlsx", sheet = "Infraestrutura")
