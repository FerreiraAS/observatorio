...
```{r projetos-de-pesquisa-em-andamento-figura, eval = has.sucupira.files}
# select data DOCENTES
projetos.doc <-
  projetos[projetos$`Categoria do Membro do Projeto` == "Docente",]
table.doc <-
...
```{r projetos-de-pesquisa-encerrados-tabela, eval = has.sucupira.files}
# select data DOCENTES
projetos.doc <-
  projetos[projetos$`Categoria do Membro do Projeto` == "Docente",]
table.doc <-
...
```{r projetos-de-pesquisa-encerrados-figura, eval = has.sucupira.files}
# select data DOCENTES
projetos.doc <-
  projetos[projetos$`Categoria do Membro do Projeto` == "Docente",]
table.doc <-
