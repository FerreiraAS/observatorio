...
discentes.raw$'Data Matrícula' <-
  as.Date(discentes.raw$'Data Matrícula', format = "%Y-%m-%d")
discentes.raw$'Data Situação' <-
  as.Date(discentes.raw$'Data Situação', format = "%Y-%m-%d")
discentes.raw$'Ano Titulação' <-
  substr(as.Date(discentes.raw$'Data Situação', format = "%Y-%m-%d"), 1, 4)
# tempo de curso
