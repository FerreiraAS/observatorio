...
for (i in 1:dim(endereco.raw)[1]) {
  if (length(grep("https://", endereco.raw[i, 2])) != 0) {
    endereco.raw[i, 2] <-
      paste( endereco.raw[i, 2], ' [↗️](', endereco.raw[i, 2], '){target="_blank"}', sep = "")
  }
}
...
```{r docentes-atual-perfil, eval = has.sucupira.files}
# projetos - membros
sheet <- "Docentes"
...
for (i in 1:dim(docentes)[1]) {
  ...
  cat('\n</center>')
  cat('\n\n<!-- -->\n\n')
  cat(paste0('*Fontes:* [**Currículo Lattes**](http://lattes.cnpq.br/', docentes$`Número do currículo Lattes`[i]),')')
  cat('\n\n<!-- -->\n\n')
  cat('<br><a style="float:right" href="#top"><b>Início &nbsp;</b>⬆️</a><br>')
}
...
```{r auto-corpo-docente, eval = has.sucupira.files}
# docentes
sheet <- "Docentes"
...
```{r docentes-2024-grafico, eval = has.sucupira.files}
# docentes
sheet <- "Docentes"
source("Scripts/read-xlsx-sucupira.R")
...
docentes.raw <- sucupira.raw
docentes.raw %>%
  janitor::mutate("Data de Admissão" = excel_numeric_to_date("Data de Admissão")) %>%
  janitor::mutate("Data de Desligamento" = excel_numeric_to_date("Data de Desligamento"))

# filter by period
id1 <-
  as.numeric(format(as.Date(docentes.raw$'Data de Admissão'), "%Y")) <= 2024 &
  as.numeric(format(as.Date(docentes.raw$'Data de Desligamento'), "%Y")) == ""
id2 <-
  as.numeric(format(as.Date(docentes.raw$'Data de Admissão'), "%Y")) <= 2024 &
  as.numeric(format(as.Date(docentes.raw$'Data de Desligamento'), "%Y")) >= as.numeric(format(Sys.Date(), "%Y"))
...
```{r docentes-2024-tabela, eval = has.sucupira.files}
# docentes
sheet <- "Docentes"
source("Scripts/read-xlsx-sucupira.R")
...
```{r docentes-2020-grafico, eval = has.sucupira.files}
# docentes
sheet <- "Docentes"
source("Scripts/read-xlsx-sucupira.R")
...
# filter by period
id1 <-
  as.numeric(format(as.Date(docentes.raw$'Data de Admissão'), "%Y")) <= 2020 &
  as.numeric(format(as.Date(docentes.raw$'Data de Desligamento'), "%Y")) == ""
id2 <-
  as.numeric(format(as.Date(docentes.raw$'Data de Admissão'), "%Y")) <= 2020 &
  as.numeric(format(as.Date(docentes.raw$'Data de Desligamento'), "%Y")) >= 2017
...
```{r docentes-2020-tabela, eval = has.sucupira.files}
# docentes
sheet <- "Docentes"
source("Scripts/read-xlsx-sucupira.R")
...
```{r docentes-2016-grafico, eval = has.sucupira.files}
# docentes
sheet <- "Docentes"
source("Scripts/read-xlsx-sucupira.R")
...
# filter by period
id1 <-
  as.numeric(format(as.Date(docentes.raw$'Data de Admissão'), "%Y")) <= 2016 &
  as.numeric(format(as.Date(docentes.raw$'Data de Desligamento'), "%Y")) == ""
id2 <-
  as.numeric(format(as.Date(docentes.raw$'Data de Admissão'), "%Y")) <= 2016 &
  as.numeric(format(as.Date(docentes.raw$'Data de Desligamento'), "%Y")) >= 2013
...
```{r docentes-2016-tabela, eval = has.sucupira.files}
# docentes
sheet <- "Docentes"
source("Scripts/read-xlsx-sucupira.R")
...
```{r docentes-2012-grafico, eval = has.sucupira.files}
# docentes
sheet <- "Docentes"
source("Scripts/read-xlsx-sucupira.R")
...
# filter by period
id1 <-
  as.numeric(format(as.Date(docentes.raw$'Data de Admissão'), "%Y")) <= 2012 &
  as.numeric(format(as.Date(docentes.raw$'Data de Desligamento'), "%Y")) == ""
id2 <-
  as.numeric(format(as.Date(docentes.raw$'Data de Admissão'), "%Y")) <= 2012 &
  as.numeric(format(as.Date(docentes.raw$'Data de Desligamento'), "%Y")) >= 2010
...
```{r docentes-2012-tabela, eval = has.sucupira.files}
# docentes
sheet <- "Docentes"
source("Scripts/read-xlsx-sucupira.R")
...
```{r pos-doc-2024, eval = has.sucupira.files}
# pos-docs
sheet <- "Pós-Doc"
source("Scripts/read-xlsx-sucupira.R")
...
docentes.raw <- sucupira.raw
docentes.raw %>%
  janitor::mutate("Vínculo Início" = excel_numeric_to_date("Vínculo Início")) %>%
  janitor::mutate("Vínculo Fim" = excel_numeric_to_date("Vínculo Fim"))

# filter by period
id1 <-
  as.numeric(format(as.Date(docentes.raw$'Vínculo Início'), "%Y")) <= 2024 &
  as.numeric(format(as.Date(docentes.raw$'Vínculo Fim'), "%Y")) == ""
id2 <-
  as.numeric(format(as.Date(docentes.raw$'Vínculo Início'), "%Y")) <= 2024 &
  as.numeric(format(as.Date(docentes.raw$'Vínculo Fim'), "%Y")) >= as.numeric(format(Sys.Date(), "%Y"))
...
```{r pos-doc-2020, eval = has.sucupira.files}
# pos-docs
sheet <- "Pós-Doc"
source("Scripts/read-xlsx-sucupira.R")
...
# filter by period
id1 <-
  as.numeric(format(as.Date(docentes.raw$'Vínculo Início'), "%Y")) <= 2020 &
  as.numeric(format(as.Date(docentes.raw$'Vínculo Fim'), "%Y")) == ""
id2 <-
  as.numeric(format(as.Date(docentes.raw$'Vínculo Início'), "%Y")) <= 2020 &
  as.numeric(format(as.Date(docentes.raw$'Vínculo Fim'), "%Y")) >= 2017
...
```{r pos-doc-2016, eval = has.sucupira.files}
# pos-docs
sheet <- "Pós-Doc"
source("Scripts/read-xlsx-sucupira.R")
...
# filter by period
id1 <-
  as.numeric(format(as.Date(docentes.raw$'Vínculo Início'), "%Y")) <= 2016 &
  as.numeric(format(as.Date(docentes.raw$'Vínculo Fim'), "%Y")) == ""
id2 <-
  as.numeric(format(as.Date(docentes.raw$'Vínculo Início'), "%Y")) <= 2016 &
  as.numeric(format(as.Date(docentes.raw$'Vínculo Fim'), "%Y")) >= 2013
...
```{r pos-doc-2012, eval = has.sucupira.files}
# pos-docs
sheet <- "Pós-Doc"
source("Scripts/read-xlsx-sucupira.R")
...
# filter by period
id1 <-
  as.numeric(format(as.Date(docentes.raw$'Vínculo Início'), "%Y")) <= 2012 &
  as.numeric(format(as.Date(docentes.raw$'Vínculo Fim'), "%Y")) == ""
id2 <-
  as.numeric(format(as.Date(docentes.raw$'Vínculo Início'), "%Y")) <= 2012 &
  as.numeric(format(as.Date(docentes.raw$'Vínculo Fim'), "%Y")) >= 2010
...
discentes.raw <-
  readxl::read_excel("PPG/Discentes.xlsx", sheet = "DATA.discentes")
...
for (j in 1:dim(periodos)[1]) {
  discentes <- discentes.raw[discentes.raw$`Ano Titulação` != "*",]
  discentes <-
    discentes[discentes$`Ano Titulação` >= periodos[j, 1] &
                discentes$`Ano Titulação` <= periodos[j, 2],]
  states$discentes <- rep(NA, dim(states)[1])
  UF <- as.data.frame(table(discentes$UF))
  for (i in 1:length(UF$Var1)) {
    states$discentes[states$abbrev_state == UF$Var1[i]] <- UF$Freq[i]
...
discentes <-
  discentes %>% dplyr::select("Ano Titulação", "Curso", "Nome", "Orientador")
doutores <-
  discentes[discentes$Curso == "Doutorado",] %>% dplyr::select("Ano Titulação", "Nome", "Orientador")
if (dim(doutores)[1] != 0) {
  doutores$Orientador <-
...
discentes <-
  discentes %>% dplyr::select("Ano Titulação", "Curso", "Nome", "Orientador")
mestres <-
  discentes[discentes$Curso == "Mestrado",] %>% dplyr::select("Ano Titulação", "Nome", "Orientador")
if (dim(mestres)[1] != 0) {
  mestres$Orientador <-
    gsub("([A-Z][A-Z][A-Z][0-9][0-9][0-9][0-9] - )",
         "",
...
membros.raw <- readxl::read_excel("PPG/Grupos de Pesquisa.xlsx", sheet = "Membros")
...
grupos.raw <- readxl::read_excel("PPG/Grupos de Pesquisa.xlsx", sheet = "GP.ativos")
...
grupos.raw <- readxl::read_excel("PPG/Grupos de Pesquisa.xlsx", sheet = "GP.externos")
