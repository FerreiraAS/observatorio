...
```{r coordenadores, eval = has.coordenacao, results = "hide"}
coordenadores <-
...
```{r docentes-2024-2021, eval = has.sucupira.files, results = "hide"}
# periodo
...
```{r docentes-2020-2017, eval = has.sucupira.files, results = "hide"}
# periodo
...
```{r docentes-2016-2013, eval = has.sucupira.files, results = "hide"}
# periodo
...
```{r docentes-2012-2010, eval = has.sucupira.files, results = "hide"}
# periodo
...
if (dim(docentes)[1] == 0) {
  ...
  table <- table.2[ids, ]
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Pós-Docs - 2024-2021")
...
if (dim(docentes)[1] == 0) {
  ...
  table <- table.2[ids, ]
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Pós-Docs - 2020-2017")
...
if (dim(docentes)[1] == 0) {
  ...
  table <- table.2[ids, ]
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Pós-Docs - 2016-2013")
...
if (dim(docentes)[1] == 0) {
  ...
  table <- table.2[ids, ]
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Pós-Docs - 2012-2010")
