...
# print tables
ids <- order(table.2$'Nome', decreasing = TRUE)
table <- docentes[ids, ]
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(table, title = "Docentes")
```
...
if (dim(docentes)[1] == 0) {
  ...
  # print tables
  ids <- order(table.2$'Pós-Doc Nome', decreasing = TRUE)
  table <- docentes[ids, ]
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Pós-Docs")
}
```
